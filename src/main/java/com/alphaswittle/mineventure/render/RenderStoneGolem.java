...
public class RenderStoneGolem extends RenderLiving {
	private static ResourceLocation golemTexture = new ResourceLocation("mineventure:textures/entity/golem/stone_golem.png");
	...
	public void doRender(EntityStoneGolem golem, double d0, double d1, double d2, float f0, float f1) {
		super.doRender(golem, d0, d1, d2, f0, f1);
	}

	protected ResourceLocation getEntityTexture(EntityStoneGolem golem) {
		return RenderStoneGolem.golemTexture;
	}

	protected void rotateCorpse(EntityStoneGolem golem, float f0, float f1, float f2) {
	...
	protected void renderEquippedItems(EntityStoneGolem golem, float f0) {
	...
	public void doRender(EntityLiving golem, double d0, double d1, double d2, float f0, float f1) {
		this.doRender((EntityStoneGolem) golem, d0, d1, d2, f0, f1);
	}

	@Override
	protected void renderEquippedItems(EntityLivingBase golem, float f0) {
		this.renderEquippedItems((EntityStoneGolem) golem, f0);
	}

	@Override
	protected void rotateCorpse(EntityLivingBase golem, float f0, float f1, float f2) {
		this.rotateCorpse((EntityStoneGolem) golem, f0, f1, f2);
	}
	...
	protected ResourceLocation getEntityTexture(Entity golem) {
		return this.getEntityTexture((EntityStoneGolem) golem);
	}
